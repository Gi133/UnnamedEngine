...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "release-2.0.14"
  WORKING_DIRECTORY "C:/Users/xkost/source/repos/UnnamedEngine/out/build/x64-Debug/_deps/sdl2-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/release-2.0.14")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "release-2.0.14")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "release-2.0.14")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/libsdl-org/SDL.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/xkost/source/repos/UnnamedEngine/out/build/x64-Debug/_deps/sdl2-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/xkost/source/repos/UnnamedEngine/out/build/x64-Debug/_deps/sdl2-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
